...
parser.add_argument("--prefix", help="prefix of file to save the sequences to", type=str, default="data/sentences_verb")
...
for subj in nouns_sg:
    for dobj in nouns_sg:
        for verb in transitive_verbs:
            sentence = " ".join(["the", subj, verb, "the", dobj, "."])
